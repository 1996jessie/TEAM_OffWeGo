...
<%
    ...
    Integer[] amount = {10000, 20000, 30000};
    Integer[] rate = {3, 5, 7};
%>
<script>
...
<div id = content_container>
	<form:form commandName="event" name="eventUpdateForm" action="eventUpdate.ev" enctype="multipart/form-data" onsubmit="return checkData()">
		<input type="hidden" name="event_num" value="${event.event_num}">
	    <input type = "hidden" name = "event_image" value = "${ event.event_image }">
	        ...
	        <div class="event-form">
	            ...
	            <div class="event-form-body">
	                ...
	                <div class="form-group">
						...
						<fmt:parseDate value="${ event.event_end_date }" var="dayFmt" pattern="yyyy-MM-dd"/>
						<fmt:formatDate var="event_end_date" value="${ dayFmt }" pattern="yyyy-MM-dd"/>
						<input type="date" name="event_end_date" class="form-control" id="eventEndDate"  value="${ event_end_date }">	                
	                </div>
