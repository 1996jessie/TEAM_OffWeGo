				...
				<div class="card-body">
					<form:form commandName="board" action="update.bd" method="post">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" value="${board.user_email}" readonly="readonly">
						...
						<div class="text-center" style="margin-top: 15px;">
							<button type="submit" class="btn btn-success" style="background-color: #80B156; border: 0px;">글 수정</button>
