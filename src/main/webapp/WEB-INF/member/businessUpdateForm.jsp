...
<div class="container-fruid min-vh-100 " id="content_container">
    <div class="content_mypage container">
        ...
        <div class="content_area">
            <form:form commandName="member" action="update.mb?pageNumber=${param.pageNumber}&whatColumn=${param.whatColumn}&keyword=${param.keyword}"  enctype="multipart/form-data" onsubmit="return validatePassword()">
            ...
            <div class="register_content_area register_insert_area profile_area">
                ...
                <div class="info_content">
                    <input type="text" name="user_account"  class="register_text_input" value="${member.user_account}">
            ...
            <div class="btn_area profile_area">
                <div class="text-end">
                    <input type="submit" value="정보수정" class="btn btn-primary" onClick = "return checkData()">
